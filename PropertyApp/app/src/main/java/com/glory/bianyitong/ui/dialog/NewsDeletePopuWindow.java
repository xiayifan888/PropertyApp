 ...
 * 删除选项
 */
public class NewsDeletePopuWindow extends PopupWindow implements View.OnClickListener {
    ...
    public NewsDeletePopuWindow(final Context context,int position,Handler del_handler) {
        super(context);
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            case R.id.news_delete: //删除
                Message msg = new Message();
                msg.arg1 = position;
                msg.what = 0;
                del_handler.sendMessage(msg);
                NewsDeletePopuWindow.this.dismiss();
                break;
