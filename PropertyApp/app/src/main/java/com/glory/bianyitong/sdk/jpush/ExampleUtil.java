...
public class ExampleUtil {
     ...
     *
     * @param context
     * @param alias    为null时不设置此值,"" （空字符串）表示取消之前的设置，字母（区分大小写）、数字、下划线、汉字，长度限制为 40
     *                 字节。（判断长度需采用UTF-8编码）
     * @param tags     为null时不设置此值,空数组或列表表示取消之前的设置，字母（区分大小写）、数字、下划线、汉字，长度限制为 40
     *                 字节，最多支持设置 100 个 tag，但总长度不得超过1K字节。（判断长度需采用UTF-8编码）
     * @param callback 在 TagAliasCallback 的 gotResult 方法，返回对应的参数 alias,
     *                 tags。并返回对应的状态码：0为成功
     ...
     *
     * @param context
     * @param alias    "" （空字符串）表示取消之前的设置,字母（区分大小写）、数字、下划线、汉字
     * @param callback 在TagAliasCallback 的 gotResult 方法，返回对应的参数 alias,
     *                 tags。并返回对应的状态码：0为成功
     ...
     *
     * @param context
     * @param tags     空数组或列表表示取消之前的设置,字母（区分大小写）、数字、下划线、汉字
     * @param callback 在 TagAliasCallback 的 gotResult 方法，返回对应的参数 alias,
     *                 tags。并返回对应的状态码：0为成功
     ...
     * @param integers  0表示星期天，1表示星期一，以此类推。
     ...
     *
     * @param context     ApplicationContext
     * @param startHour   int startHour 静音时段的开始时间 - 小时 （24小时制，范围：0~23 ）
     * @param startMinute int startMinute 静音时段的开始时间 - 分钟（范围：0~59 ）
     * @param endHour     int endHour 静音时段的结束时间 - 小时 （24小时制，范围：0~23 ）
     * @param endMinute   int endMinute 静音时段的结束时间 - 分钟（范围：0~59 ）
     */
    ...
    public static void showLocalNotification(Context context, long number,
        ...
        localNotificationBuilder builder = new localNotificationBuilder(
                context);
    ...
    public static class CustomNotificationBuilder {
         ...
         * 设置行为
         *
         * @param flags 例如 Notification.FLAG_AUTO_CANCEL; 自动消失
         * @return
         */
         ...
         * 设置铃声，震动，提示灯
         *
         * @param defaults 铃声 Notification.DEFAULT_SOUND; 震动
    ...
    public static class localNotificationBuilder {
         ...
         *
         * @param extras Map<String , Object>
         * @return
         */
